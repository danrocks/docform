  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-brand-900">Submissions</h1>
          <p className="text-sm text-brand-500 mt-0.5">{submissions.length} total</p>
        </div>
      </div>
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="p-10 text-center text-brand-400 text-sm">No submissions found</div>
        ) : (
